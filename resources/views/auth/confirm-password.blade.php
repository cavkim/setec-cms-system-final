...
<head>
    ...
    <title>CMS — Confirm Password</title>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <input id="password" name="password" type="password" required
                                autocomplete="current-password" placeholder="Enter your password" class="w-full bg-surface-container-lowest border-0 rounded-xl py-3.5 pl-12 pr-4
