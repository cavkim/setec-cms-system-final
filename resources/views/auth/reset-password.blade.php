        ...
        <div class="relative w-full max-w-md z-10">
            ...
            <div
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <input id="email" name="email" type="email" value="{{ old('email', $request->email) }}"
                                required autofocus autocomplete="username" class="w-full bg-surface-container-lowest border-0 rounded-xl py-3.5 pl-12 pr-4
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <input id="password" name="password" type="password" required autocomplete="new-password"
                                placeholder="Min 8 characters" class="w-full bg-surface-container-lowest border-0 rounded-xl py-3.5 pl-12 pr-4
                                          text-on-surface placeholder:text-outline/50
                                          ring-1 ring-outline-variant/20 focus:ring-2 focus:ring-primary
                                          transition-all duration-200 outline-none
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <input id="password_confirmation" name="password_confirmation" type="password" required
                                autocomplete="new-password" placeholder="Repeat new password" class="w-full bg-surface-container-lowest border-0 rounded-xl py-3.5 pl-12 pr-4
                                          text-on-surface placeholder:text-outline/50
                                          ring-1 ring-outline-variant/20 focus:ring-2 focus:ring-primary
                                          transition-all duration-200 outline-none
                                          {{ $errors->get('password_confirmation') ? 'ring-error/60' : '' }}" />
                        </div>
                ...
                <div class="mt-6 text-center">
                    <a href="{{ route('login') }}" class="text-sm text-on-surface-variant hover:text-primary transition-colors
